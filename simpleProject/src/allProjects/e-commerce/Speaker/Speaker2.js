...
export default function Tv({heart,Speaker_Tv,setSpeaker_Tv,setheart,secart,cart}) {
      ...
      {Speaker_Tv.map(e=>{
        return (
          <section className='tvBanner' key={e.id}>
             <div id='upper'>
                <div id="tvBanner_imagw"><img src={e.src} height='100px' width="100px" alt={e.name}/></div>
                <div id="name_cost">
